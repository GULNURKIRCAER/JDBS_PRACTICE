...
//        System.out.println("phone = " + phone);
    ...
    public void getAllSpartanWithPath(){
        ...
        String lastFirstName = response.path("name[-2]");//SYNTAX Gpath
        System.out.println("lastFirstName = " + lastFirstName);

        int lastId = response.path("id[-1]");// sonuncu olan -1
        System.out.println("lastId = " + lastId);

        //print all names of spartans  TUM ISIMLER STRING OLD ICIN BU DAHA KOLAY
