...
public class Pojo_deserialize {
    ...
    public void oneSpartanPojo(){
        Response response = given().accept(ContentType.JSON)
                .pathParam("id", 15)
                .when().get("http://52.90.239.48:8000/api/spartans/{id}");
        ...
        System.out.println(spartan15);//AYNISI
    ...
    public void gson_example() {
        ...
        Gson gson=new Gson();
        //gson is one converter java or POJO  to json
        //gson-->is one converter json to java
        String myJsonData = "{\n" +
                "    \"id\": 15,\n" +
                "    \"name\": \"Meta\",\n" +
                "    \"gender\": \"Female\",\n" +
        ...
        //System.out.println(jsonSpartanEU);//JSON FORMAT
    }
