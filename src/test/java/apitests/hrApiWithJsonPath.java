...
public class hrApiWithJsonPath {
    ...
    public void test1(){
        ...
        List<String> countryNamesWithRegionId2 =jsonPath.getList("items.findAll {it.region_id==3}.country_name");

        //List<String> countryNamesWithRegionId2 =response.path("items.findAll {it.region_id==2}.country_name"); BUDA OLUR
                                                                                //like if statement
    ...
    public void test2(){
        ...
        System.out.println(firstNames);                     //GPATH SYNTAX
